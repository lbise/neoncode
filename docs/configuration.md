...
External workspace files, live application of xterm terminal appearance, font discovery, and broader CLI app-control beyond workspace list/open are later milestones.
