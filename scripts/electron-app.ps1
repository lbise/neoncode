...
function Copy-ElectronAppFiles {
    ...
    foreach ($file in @("package.json", "package-lock.json", "tsconfig.base.json", "tsconfig.node.json", "tsconfig.renderer.json", "tsconfig.tests.json", "main.ts", "preload.ts", "config-store.ts", "token-loader.ts", "index.html", "styles.css", "renderer.ts")) {
